...
import pro.leandev.zeroconf.notification.message.Headers.Companion.NOTIFY
import pro.leandev.zeroconf.notification.message.Headers.Companion.NOTIFY_ALIVE
import pro.leandev.zeroconf.notification.message.Headers.Companion.NOTIFY_BYE
import pro.leandev.zeroconf.notification.message.Headers.Companion.NOTIFY_UPDATE
import pro.leandev.zeroconf.notification.message.Headers.Companion.OK
import pro.leandev.zeroconf.notification.message.Headers.Companion.SEARCH
import pro.leandev.zeroconf.notification.message.Headers.Companion.SSDP_MAN
...
enum class SsdpMessageType(val method: String, val headers: MutableMap<Headers, String>) {
    ...
    companion object {
        ...
        fun from(firstLine: String, hdrs: Map<Headers, String>): SsdpMessageType {
            when (firstLine.uppercase().trim('\r')) {
